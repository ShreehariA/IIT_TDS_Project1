...
"""
    ...
    try:
        ...
        return {"status": "success", "output": f"executed {script_name}"}
...
def handle_code_error(error: str, original_task: str, code: str) -> Dict:
        ...
        "messages": [
            ...
            },
            {
                ...
                2. For tasks that need file processing (like counting dates, sorting JSON, etc.), 
                   ...
                   - Specify all required dependencies except the once in standard Python library
    ...
    try:
        ...
        if tool_call["function"]["name"] == "script_runner":
            ...
            if result["status"] == "error":
                return handle_code_error(result["error"], task, result["code"])
