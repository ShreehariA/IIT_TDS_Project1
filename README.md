...
## Project overview (Project 1 - LLM-based Automation Agent)
### Background
...
- Add an [MIT LICENSE](https://docs.github.com/en/communities/setting-up-your-project-for-healthy-contributions/adding-a-license-to-a-repository) file
